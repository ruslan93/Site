...
function left_carusel2(){
   ...
   $(".carousel-items2").animate({left: "0px"}, 700); 
   $(".carousel-items2 .carousel-block2").eq(-1).remove(); 
}
function right_carusel2(){
   var block_width = $('.carousel-block2').width() - 10;
   $(".carousel-items2").animate({left: "-"+ block_width +"px"}, 700); 
   (function () { 
...
function left_carusel3(){
   ...
   $(".carousel-items3").animate({left: "0px"}, 700); 
   $(".carousel-items3 .carousel-block3").eq(-1).remove(); 
}
function right_carusel3(){
   var block_width = $('.carousel-block3').width() - 10;
   $(".carousel-items3").animate({left: "-"+ block_width +"px"}, 700); 
   (function () { 
